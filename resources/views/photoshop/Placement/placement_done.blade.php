...
<main class="main-wrapper clearfix">
  ...
  <div class="row page-title clearfix">
    {{ Breadcrumbs::render('placement_done') }}
      <!-- /.page-title-right -->
  </div>
  <!-- /.page-title -->
  <!-- =================================== -->
  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"   id="placementdone" >
  							<thead>
  								<tr class="bg-primary">
									<th class="checkboxth">
