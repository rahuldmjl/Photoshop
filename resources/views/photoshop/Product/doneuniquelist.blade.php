...
<main class="main-wrapper clearfix">
  ...
  <div class="row page-title clearfix">
    {{ Breadcrumbs::render('doneuniquelist') }}
      <!-- /.page-title-right -->
  </div>
  <!-- /.page-title -->
  <!-- =================================== -->
  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-heading clearfix">
  						<h5 style="float:left" class="border-b-light-1 pb-1 mb-2 mt-0 w-100">Done Unique List</h5>
					</div>
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"  data-toggle="datatables">
                          ...
                          <tr>
                            <td>{{$item->getproduct->sku}}</td>
                            <td>{{$item->getcategory->name}}</td>
                            <td>{{$item->getsubcategory->subcatname}}</td>
                            <td>{{$item->skuname}}</td>
