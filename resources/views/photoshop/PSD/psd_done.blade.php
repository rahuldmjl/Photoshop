			...
			<div class="col-md-12 widget-holder">
			  <div class="widget-bg">
				<div class="widget-body clearfix">
				  <h5 class="box-title">Photography Done Filter</h5>
				  <div class="tabs">
  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"   id="psddonelist" >
  							<thead>
  								<tr class="bg-primary">
									<th class="checkboxth">
...
<input type="hidden" id="psddonelistajax" value="{{route('ajax_table')}}">
<style type="text/css">
...
var table=$('#psddonelist').DataTable({
	"aoColumnDefs": [
  ...
  "buttons": [
	$.extend( true, {}, buttonCommon, {
      extend: 'csv',
      footer: false,
      title: 'Photography-psd-done-list',
  ...
  "deferLoading": <?=$psd_done_list->count()?>,
  "processing": true,
  "serverSide": true,
  "searching": false,
  "serverMethod": "post",
