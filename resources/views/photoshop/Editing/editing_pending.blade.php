...
<main class="main-wrapper clearfix">
  ...
  <div class="row page-title clearfix">
    {{ Breadcrumbs::render('editing.pending') }}
      <!-- /.page-title-right -->
  </div>
  <!-- /.page-title -->
  <!-- =================================== -->
			...
			<div class="col-md-12 widget-holder">
			  <div class="widget-bg">
				<div class="widget-body clearfix">
				  <h5 class="box-title">Editing pending Filter</h5>
				  <div class="tabs">
  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"  id="editing_pending_list">
							<thead>
								<tr class="bg-primary">
									<th class="checkboxth">
...
<!-- /.main-wrappper -->
<input type="hidden" id="editingpendinglist" value="{{route('get_ajax_list_editing')}}">
<style type="text/css">
...
var table=$('#editing_pending_list').DataTable({
  ...
  "buttons": [
	$.extend( true, {}, buttonCommon, {
      extend: 'csv',
      footer: false,
      title: 'Editing-pending-product-list',
  ...
  "deferLoading": <?=$psd_done->count()?>,
  "processing": true,
  "serverSide": true,
  "searching": false,
  "serverMethod": "post",
  "ajax":{
	"url": $("#editingpendinglist").val(),
